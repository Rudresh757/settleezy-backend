...
const OldPartnerApplicationSchema = new mongoose.Schema(
  {
  ...
  {
    timestamps: true,
    collection: 'old_partner_applications',
  }
)

module.exports = mongoose.model('OldPartnerApplication', OldPartnerApplicationSchema)
