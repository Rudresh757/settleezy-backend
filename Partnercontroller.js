...
const submitApplication = async (req, res) => {
  try {
    ...
    //     ['Trading Name', formData.tradingName], ['Legal Name', formData.legalName],
    //     ['Reg. Number', formData.regNumber], ['Year Established', formData.yearEstablished],
    ...
    //   return res.status(502).json({ success: false, message: 'Partner application saved, but email delivery failed.', ref, id: application._id, mailErrors })
    // }
    // ── END EMAIL BLOCK ──────────────────────────────────────────────────────
