...
const CommunityPartnerApplicationSchema = new mongoose.Schema(
  {
    ...
    // ── Step 5: Partnership Path & Tier ───────────────────────
    partnershipPath: { type: String, trim: true }, // 'a' | 'b'
    postTrialTier:   { type: String, trim: true }, // optional post-trial pref for path 'a'
    selectedTier:    { type: String, trim: true }, // 'root' | 'reach' | 'rise' | 'landmark'
  ...
  {
    timestamps: true,
    collection: 'community_partner_applications',
  }
)

module.exports = mongoose.model('CommunityPartnerApplication', CommunityPartnerApplicationSchema)
